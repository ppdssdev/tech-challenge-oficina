...
| Identificação por CPF/CNPJ | `WorkOrderCustomerInput.documentNumber` + `DocumentValidator` |
...
| Validação CPF/CNPJ | `DocumentValidator` |
| Validação placa | `VehiclePlateValidator` |
